...
class QwenImageDecoder3d(nn.Module):
    ...
    def __init__(
        ...
        # output blocks
        self.norm_out = QwenImageRMS_norm(out_dim, images=False)
        self.conv_out = QwenImageCausalConv3d(out_dim, 3*int(upsampler_factor*upsampler_factor), 3, padding=1)
...
class AutoencoderKLQwenImage(ModelMixin, ConfigMixin, FromOriginalModelMixin):
    ...
    # fmt: on
        ...
        self.decoder = QwenImageDecoder3d(
            base_dim, z_dim, dim_mult, num_res_blocks, attn_scales, self.temperal_upsample, dropout, upsampler_factor
        )
